...
fuelCapacity_matrix=1*[a_fuelCapacity,a_fuelCapacity*0.8,a_fuelCapacity*0.8;
    b_fuelCapacity,b_fuelCapacity*0.8,b_fuelCapacity*0.8;
    ...
    for ship_type=ship_type_fix     
        for fuel_type=fuel_type_fix    
            ...
            for i=2*start_Line:2*end_Line
                ...
                for x=2:length+1
                    PORTDIST(1,x-1)=LineNetwork(x,i-1);
                    ...
                    for y=x+1:length+1
                        ...
                        Revenue(x-1,y-1)=0.2*Distance(x-1,y-1)+500;
...
for ship_type=ship_type_fix    %12000 16000 20000TEU
    for fuel_type=fuel_type_fix    %Scene1 Scene2 Scene3
        ...
        for i=2*start_Line:2*end_Line
            ...
            for cc=1:N_big
                ...
                num_M=1;
                AllLineResult_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(1,cc)=Best_Objective;
                AllLineResult_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(2,cc)=Total_Income;
                AllLineResult_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(3,cc)=Total_cargocost;
                AllLineResult_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(4,cc)=Total_empty_cargocost;
                AllLineResult_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(5,cc)=Total_Fuel_Cost;
                AllLineResult_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(6,cc)=Carbon_tax;
                AllLineResult_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(7,cc)=Total_Fixed_Cost;
                AllLineResult_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(8,cc)=NumOfShip;
                AllLineResult_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(9,cc)=average_Speed;
                Big_Cargo_Matrix_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}{1,cc}=  Cargo_Matrix;
                Big_Empty_Cargo_Matrix_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}{1,cc}= Empty_Cargo_Matrix;
                Big_All_Fuel_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(1:length,cc)= Fuel(1:length,1);
                Big_Real_Speed_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(1:length,cc)= Real_Speed(1:length,1);
                Big_Fuel_Remain_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(1:length,cc)= Fuel_Remain(1:length,1);
                Big_Fuel_Consume_LOW{num_M,1}{ship_type,fuel_type}{1,i/2}(1:length,cc)=  Fuel_Consume(1:length,1);
            end
            save('Result_LOW.mat')
        end
    end
